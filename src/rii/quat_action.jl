...
# compute M[1, 1]*P + M[2, 1]*Q, M[1, 2]*P + M[2, 2]*Q for a basis (P, Q) of E[2^e]
function action_of_matrix(M::Matrix{BigInt}, a24::Proj1{T}, xP::Proj1{T}, xQ::Proj1{T}, xPQ::Proj1{T}, e::Int, Ponly::Bool=false) where T <: RingElem
    xP_new = linear_comb_2_e(M[1, 1], M[2, 1], xP, xQ, xPQ, a24, e)
    Ponly && return xP_new
    xQ_new = linear_comb_2_e(M[1, 2], M[2, 2], xP, xQ, xPQ, a24, e)
    xPQ_new = linear_comb_2_e(M[1, 1] - M[1, 2], M[2, 1] - M[2, 2], xP, xQ, xPQ, a24, e)
