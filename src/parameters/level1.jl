...
function make_E0_data()
    ...
    xP3e = Proj1(2006982394376954054746282658989847061026521116048221434820315293094959912872476*Fp2_i + 108938614186280581715727671435891067310712878773562090392725294703051835860519)
    xQ3e = Proj1(3580470049332746741947130760416220554306664994686110901933585473854957312084444*Fp2_i + 4886745583818571840949688587415249425980637476684590448621209502512499302639836)
    xPQ3e = Proj1(365566082134588903152823479590501211632413294369136843996845965179458509533328*Fp2_i + 4618265075509830736036572980512249261476852782565570996028262757136310525902466)
    ...
    return Fp2, E0Data(A0, A0d, A0dd, a24_0, jInvariant_A(A0), P2e, Q2e, xP2e, xQ2e, xPQ2e, Matrices_2e, xP3e, xQ3e, xPQ3e, Matrices_3e, w, isomorphism_to_A0, dlog_data, tp_table)
end
